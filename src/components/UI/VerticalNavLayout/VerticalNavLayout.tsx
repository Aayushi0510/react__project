...
const VerticalNavLayout = ({isCollapsed, toggleCollapse, isPathEqualtoNavItem= (navItem) => false ,navigation}:props) => {
      ...
      >
        ...
        {!isCollapsed && (
          <div className="font-semibold text-xl">
            <img src="/telemartLogo.png" alt="Logo" className="h-full w-[130px]" />
          </div>
        )}
